...
@section('title', 'AI Scanner Penyakit Tanaman (Terbatas)')
@section('content')

<div class="bg-white rounded-xl shadow-sm p-6 max-w-2xl">
    <h2 class="text-lg font-semibold text-gray-800 mb-1">🔬 AI Scanner Penyakit Tanaman</h2>
    <p class="text-sm text-gray-500 mb-1">
        Versi edukatif untuk masyarakat umum — upload foto tanaman untuk mengenali indikasi penyakitnya.
    </p>
    <p class="text-xs text-amber-600 mb-6">
        ℹ️ Fitur ini bersifat edukatif. Untuk penanganan lahan pertanian sungguhan, gunakan akun Petani
        agar hasil deteksi bisa ditindaklanjuti oleh Petugas Penyuluh.
    </p>
    ...
    <form method="POST" action="{{ route('user.deteksi-penyakit.store') }}"
