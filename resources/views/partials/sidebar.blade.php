    ...
    $sidebarConfig = [
        ...
        'petani' => [
            ...
            'menu' => [
                ...
                ['label' => 'Analisis Cuaca', 'route' => 'cuaca.index'],
                ['label' => 'AI Scanner Penyakit', 'route' => 'petani.deteksi-penyakit.create'],
                ['label' => 'Riwayat Deteksi Penyakit', 'route' => 'petani.deteksi-penyakit.index'],
        ...
        'user' => [
            ...
            'menu' => [
                ...
                ['label' => 'AI Scanner (Terbatas)', 'route' => 'user.deteksi-penyakit.create'],
                ['label' => 'Analisis Cuaca', 'route' => 'cuaca.index'],
        ...
        'penyuluh' => [
            ...
            'menu' => [
                ...
                ['label' => 'Deteksi Penyakit (Wilayah)', 'route' => 'penyuluh.deteksi-penyakit.index'],
